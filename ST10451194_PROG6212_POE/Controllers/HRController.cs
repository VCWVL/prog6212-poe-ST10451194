...
namespace ST10451194_PROG6212_POE.Controllers
{
    ...
    public class HRController : Controller
    {
        ...
        public async Task<IActionResult> GenerateReport(string reportType, DateTime startDate, DateTime endDate, string reportName)
        {
            ...
            IQueryable<ST10451194_PROG6212_POE.Models.Claim> claimsQuery = _context.Claims.Where(c => c.DateSubmitted >= startDate && c.DateSubmitted <= endDate);
            ...
            using (var ms = new MemoryStream())
            {
                ...
                document.Add(new Paragraph(" MonthlyClaimSystem Lecturer Contract Monthly Claim System Report"));
                document.Add(new Paragraph("========================================================"));
