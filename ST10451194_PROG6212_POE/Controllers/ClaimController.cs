...
using ST10451194_PROG6212_POE.Data; // Imports the project's Data namespace, which likely includes database context and data models.
using ST10451194_PROG6212_POE.Models; // Imports the Models namespace, where custom models like ClaimViewModel and Claim may be defined.
using System; // Provides fundamental classes and base types, such as DateTime and Array.

namespace ST10451194_PROG6212_POE.Controllers // Defining the namespace for organizing code related to the project’s controllers.
{// Namespace start
