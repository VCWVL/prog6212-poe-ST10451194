...
{//namespace begin
    ...
    {//ProgrammeCoordinator controller begin
        ...
        //This method is responsible for displaying a list of claims pending approval from the programme coordinator.
        public IActionResult Index()
        {
            ...
            var pendingClaims = _context.Claims
                ...
                .Where(c => !c.IsApprovedByCoordinator && c.Status == "Pending") //These are the conditions for claims that can be vuewd by the programme Coordinator
                .ToList();
